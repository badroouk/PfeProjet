...
void loop() {
    ...
    Serial.print("GET http://192.168.11.103/iot/dht.php?&temperature=");
    client.print("GET http://192.168.11.103/iot/dht.php?&temperature=");     //YOUR URL
    Serial.println(temp);
    client.print(temp);
    ...
    client.println();
    client.println("Host: 192.168.11.103");
